...
class Plantilla {
    ...
    public static function iniciar($tituloComponente = true) {
        ...
        if (!empty($pance["nombre"]) && !empty($pance["version"])) {
            $generador = $pance["nombre"]." ".$pance["version"];
            $titulo    = $generador." :: ";
        } else {
            $generador = "";
            $titulo    = "";
        ...
        if (!empty($pance["creador"]) && !empty($pance["correoCreador"])) {
            $autor = $pance["creador"]." :: ".$pance["correoCreador"];
        } else {
            $autor = "";
        }

        if (!empty($pance["descripcion"])) {
            $descripcion = $pance["descripcion"];
        } else {
            $descripcion = "";
        }

        if (!empty($pance["creador"]) && !empty($pance["urlCreador"])) {
            $pie  = $pance["nombre"]." :: ".$pance["descripcion"];
            $pie .= "<br>&copy; ".date("Y")." ".HTML::enlazarPagina($pance["creador"], $pance["urlCreador"]);
        } else {
            $pie = "";
        }
