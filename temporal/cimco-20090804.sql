...
CREATE TABLE `pance_cotizaciones` (
  ...
  `porcentaje_mano_obra` decimal(4,2) default NULL COMMENT 'Porcentaje que le corresponde al consorciado por la mano de obra',
  `porcentaje_materiales` decimal(4,2) default NULL COMMENT 'Porcentaje que le corresponde al consorciado por materiales',
...
INSERT INTO `pance_cotizaciones` VALUES (000001,00000001,NULL,NULL,NULL,'0','5','20000000.00','30000000.00','50000000.00','5.00','2500000.00','10.00','5000000.00','15.00','7500000.00','16.00','1200000.00','0',NULL,NULL,NULL,00000001,00,'C1','2009-08-05 00:08:57'),(000002,00000001,NULL,NULL,NULL,'0','4','5000000.00','5000000.00','10000000.00','5.00','500000.00','10.00','1000000.00','15.00','1500000.00','16.00','240000.00','1',NULL,NULL,NULL,00000001,01,'C1','2009-08-05 00:08:10'),(000003,00000001,'2009-08-05','2009-08-05 00:08:29',NULL,'0','2','5000000.00','10000000.00','15000000.00','5.00','750000.00','10.00','1500000.00','15.00','2250000.00','16.00','360000.00','1',NULL,NULL,NULL,00000001,02,'C1','2009-08-05 00:08:10'),(000004,00000001,'2009-08-05','2009-08-05 00:08:16',NULL,'1','2','10000000.00','15000000.00','25000000.00','5.00','1250000.00','10.00','2500000.00','15.00','3750000.00','16.00','600000.00','1',NULL,NULL,NULL,00000001,03,'C1','2009-08-05 00:08:10'),(000005,00000001,NULL,NULL,NULL,'0','1','4000000.00','4000000.00','8000000.00','5.00','400000.00','10.00','800000.00','15.00','1200000.00','16.00','192000.00','1',NULL,NULL,NULL,00000001,04,'C1','2009-08-05 00:08:00'),(000006,00000003,NULL,NULL,NULL,'0','5','85000000.00','5600000.00','90600000.00',NULL,NULL,NULL,NULL,NULL,NULL,'16.00','14496000.00','0','0.00',NULL,NULL,00000002,00,'C1','2009-08-05 00:08:03'),(000007,00000003,NULL,NULL,NULL,'0','1','40000000.00','2600000.00','42600000.00',NULL,NULL,NULL,NULL,NULL,NULL,'16.00','6816000.00','1',NULL,NULL,NULL,00000002,01,'C1','2009-08-05 00:08:19'),(000008,00000003,NULL,NULL,NULL,'0','1','45000000.00','2000000.00','47000000.00',NULL,NULL,NULL,NULL,NULL,NULL,'16.00','7520000.00','1',NULL,NULL,NULL,00000002,02,'C1','2009-08-05 00:08:19');
...
INSERT INTO `pance_requerimientos_clientes` VALUES (00000001,00000006,90000,'M','2009-08-04','2009-08-04 11:08:42',NULL,NULL,'PRUEBA NUMERO 1','PARA COTIZAR','undefined','2009-08-05','JESUS MAURICIO CHAVARRO',NULL,NULL,'1','1','1',NULL),(00000002,00000003,90000,'M','2009-08-04','2009-08-04 11:08:53',NULL,NULL,'PRUEBA NUMERO 2','PARA  VISITAR','NECESARIOS AJUSTES DE TORNILLERIA','2009-08-04','JESUS MAURICIO CHAVARRO',NULL,NULL,'0','1','1',NULL),(00000003,00000004,90002,'M','2009-08-04','2009-08-04 11:08:03',NULL,NULL,'PRUEBA NUMERO 3','ANULAR','undefined','2009-08-04','JESUS MAURICIO CHAVARRO',NULL,NULL,'1','1','1',NULL),(00000004,00000008,90003,'E','2009-08-04','2009-08-04 11:08:13',NULL,NULL,'PRUEBA NUMERO 4',NULL,'undefined','2009-08-04','JESUS MAURICIO CHAVARRO',NULL,NULL,'0','1','1',NULL),(00000005,00000007,90002,'P','2009-08-04','2009-08-04 11:08:23',NULL,NULL,'PRUEBA NUMERO 5',NULL,'PROBLEMAS LOGISTICOS DE USUARIO','2009-08-04','JESUS MAURICIO CHAVARRO',NULL,NULL,'0','1','1',NULL);
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `pance_buscador_registro_obras` AS select `pance_cotizaciones`.`id` AS `id`,`pance_requerimientos_clientes`.`fecha_ingreso` AS `fecha_ingreso`,`pance_requerimientos_clientes`.`id_sede` AS `id_sede`,`pance_sedes_clientes`.`nombre_sede` AS `nombre_sede`,`pance_sedes_clientes`.`id_municipios` AS `municipio`,`pance_requerimientos_clientes`.`id_sucursal` AS `sucursal`,`pance_registro_obras`.`valor_facturar` AS `valor_facturar`,(case `pance_requerimientos_clientes`.`tipo_solicitud` when _utf8'M' then _utf8'Mantenimiento' when _utf8'E' then _utf8'Emergencia' when _utf8'S' then _utf8'Servicio por demanda' when _utf8'P' then _utf8'Proyecto' when _utf8'V' then _utf8'Visita' end) AS `tipo_solicitud`,`pance_requerimientos_clientes`.`descripcion` AS `descripcion` from (((((`pance_requerimientos_clientes` join `pance_sedes_clientes`) join `pance_sucursales`) join `pance_cotizaciones`) join `pance_municipios`) join `pance_registro_obras`) where ((`pance_cotizaciones`.`id_requerimiento` = `pance_requerimientos_clientes`.`id`) and (`pance_requerimientos_clientes`.`id_sede` = `pance_sedes_clientes`.`id`) and (`pance_requerimientos_clientes`.`id_sucursal` = `pance_sucursales`.`id`) and (`pance_municipios`.`id` = `pance_sedes_clientes`.`id_municipios`)) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`cimco`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `pance_buscador_requerimientos_clientes` AS select `pance_requerimientos_clientes`.`id` AS `id`,`pance_sedes_clientes`.`nombre_sede` AS `nombre_sede`,`pance_sucursales`.`nombre` AS `sucursal`,(case `pance_requerimientos_clientes`.`tipo_solicitud` when _latin1'M' then _latin1'Mantenimiento' when _latin1'E' then _latin1'Emergencia' when _latin1'S' then _latin1'Servicio por demanda' when _latin1'P' then _latin1'Proyecto' when _latin1'V' then _latin1'Visita' end) AS `tipo_solicitud`,(case `pance_requerimientos_clientes`.`estado_cotizacion` when _latin1'1' then _latin1'Pendiente' when _latin1'2' then _latin1'Aprobada' when _latin1'3' then _latin1'Anulada' when _latin1'4' then _latin1'Recotizar' when _latin1'5' then _latin1'Reemplazada' when _latin1'6' then _latin1'No cotizada' when _latin1'7' then _latin1'No requiere' end) AS `estado_cotizacion`,`pance_requerimientos_clientes`.`nombre_contacto` AS `contacto` from ((`pance_requerimientos_clientes` join `pance_sedes_clientes`) join `pance_sucursales`) where ((`pance_requerimientos_clientes`.`id_sede` = `pance_sedes_clientes`.`id`) and (`pance_requerimientos_clientes`.`id_sucursal` = `pance_sucursales`.`id`)) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `pance_menu_actas` AS select `pance_registro_obras`.`id` AS `id`,(case `pance_registro_obras`.`tipo_acta` when _utf8'1' then _utf8'Inicio' when _utf8'2' then _utf8'Avance obra' when _utf8'3' then _utf8'Finalización' end) AS `TIPO_ACTA`,`pance_registro_obras`.`fecha_entrega_acta` AS `FECHA_ENTREGA_ACTA`,`pance_registro_obras`.`valor_facturar` AS `VALOR_FACTURAR`,if((`pance_registro_obras`.`factura_consorciado` = _latin1'0'),_utf8'No realizada',_utf8'Realizada') AS `FACTURA_CONSORCIADO`,if((`pance_registro_obras`.`pago_cliente` = _latin1'0'),_utf8'Pendiente',_utf8'Pagada') AS `PAGO_CLIENTE`,if((`pance_registro_obras`.`pago_consorciado` = _latin1'0'),_utf8'Pendiente',_utf8'Pagada') AS `PAGO_CONSORCIADO`,`pance_registro_obras`.`porcentaje_mano_obra` AS `PORCENTAJE_MANO_OBRA`,`pance_registro_obras`.`porcentaje_materiales` AS `PORCENTAJE_MATERIALES` from ((`pance_registro_obras` join `pance_cotizaciones`) join `pance_requerimientos_clientes`) where ((`pance_registro_obras`.`id_cotizacion` = `pance_cotizaciones`.`id`) and (`pance_registro_obras`.`id_requerimiento` = `pance_requerimientos_clientes`.`id`)) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`cimco`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `pance_menu_reporte_visitas` AS select `pance_requerimientos_clientes`.`id` AS `id`,`pance_sedes_clientes`.`nombre_sede` AS `SEDE`,`pance_sucursales`.`nombre` AS `SUCURSAL`,`pance_requerimientos_clientes`.`fecha_ingreso` AS `FECHA_INGRESO`,`pance_requerimientos_clientes`.`descripcion` AS `DESCRIPCION`,`pance_municipios`.`nombre` AS `MUNICIPIO` from (((`pance_requerimientos_clientes` join `pance_sedes_clientes`) join `pance_sucursales`) join `pance_municipios`) where ((`pance_requerimientos_clientes`.`id_sede` = `pance_sedes_clientes`.`id`) and (`pance_requerimientos_clientes`.`id_sucursal` = `pance_sucursales`.`id`) and (`pance_requerimientos_clientes`.`notificado` = _latin1'1') and (`pance_requerimientos_clientes`.`estado_aprobacion_requerimiento` = _latin1'0') and (`pance_sedes_clientes`.`id_municipios` = `pance_municipios`.`id`) and (`pance_requerimientos_clientes`.`estado_cotizacion` <> _latin1'7')) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `pance_seleccion_requerimientos_clientes` AS select `pance_requerimientos_clientes`.`id` AS `id`,`pance_sedes_clientes`.`nombre_sede` AS `nombre_sede`,`pance_sucursales`.`nombre` AS `sucursal`,(case `pance_requerimientos_clientes`.`tipo_solicitud` when _latin1'M' then _latin1'Mantenimiento' when _latin1'E' then _latin1'Emergencia' when _latin1'S' then _latin1'Servicio por demanda' when _latin1'P' then _latin1'Proyecto' end) AS `tipo_solicitud` from ((`pance_requerimientos_clientes` join `pance_sedes_clientes`) join `pance_sucursales`) where ((`pance_requerimientos_clientes`.`id_sede` = `pance_sedes_clientes`.`id`) and (`pance_requerimientos_clientes`.`id_sucursal` = `pance_sucursales`.`id`)) */;
...
-- Dump completed on 2009-08-05  4:51:12
