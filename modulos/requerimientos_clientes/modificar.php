        ...
        /*} else if($datos->estado == '4' || $datos->estado == '5'){
            ...
            $formularios["PESTANA_COTIZACION"] = array(
                array(
                    ...
                    HTML::campoTextoCorto("consecutivo_cotizacion", $textos["CONSECUTIVO_COTIZACION"], 2, 2, $datos->consecutivo_cotizacion, array("readOnly" => "true")),
                ...
                array(
                    HTML::campoTextoCorto("numero_contrato", $textos["NUMERO_CONTRATO"], 15, 15, $datos->numero_contrato, array("title" => $textos["AYUDA_CONTRATO"])),
                    HTML::campoTextoCorto("numero_poliza", $textos["NUMERO_POLIZA"], 15, 15, $datos->numero_poliza, array("title" => $textos["AYUDA_POLIZA"]))
                ),
                array(
...
/*** Adicionar los datos provenientes del formulario ***/
    ...
    if($forma_aiu == 1){
        if (empty($forma_numero_cotizacion)){
            ...
            $modificar = SQL::modifcar("cotizaciones", $datos,"id='$forma_id'");
        ...
        if (empty($forma_numero_cotizacion) ||
            ...
            $modificar = SQL::modificar("cotizaciones", $datos,"id='$forma_id'");
