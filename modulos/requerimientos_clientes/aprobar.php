...
if (!empty($url_generar)) {
    ...
    if (empty($url_id)) {
        ...
        if($datos->estado != '1' && $datos->estado == '3' && $datos->estado != '4'){
            $error     = $textos["ERROR_APROBAR_ITEM"];
            $titulo    = "";
            $contenido = "";
            ...
            $formularios["PESTANA_REQUERIMIENTO"] = array(
                ...
                array(
    	            HTML::campoTextoCorto("observaciones_aprobacion_cliente", $textos["OBSERVACIONES_APROBACION"], 60, 255, "", array("title" => $textos["AYUDA_OBSERVACIONES_APROBACION"])),
                    HTML::campoTextoCorto("fecha_registro_aprobacion_clientes", $textos["FECHA_APROBACION"], 10, 10, date("Y-m-d"), array("class" => "selectorFecha"), array("title" => $textos["AYUDA_FECHA_APROBACION"])),
    	            HTML::campoTextoCorto("numero_contrato", $textos["NUMERO_CONTRATO"], 15, 15, "", array("title" => $textos["AYUDA_CONTRATO"])),
    	            HTML::campoTextoCorto("numero_poliza", $textos["NUMERO_POLIZA"], 15, 15, "", array("title" => $textos["AYUDA_POLIZA"]))
                ),
                array(
                ...
                array(
                    HTML::mostrarDato("tipo_solicitud", $textos["TIPO_SOLICITUD"], $tipo_solicitud[$datosRequerimiento->tipo_solicitud])
                ),
                array(
...
/*** Adicionar los datos provenientes del formulario ***/
    ...
    $forma_fecha_registro_aprobacion_sistema = date("Y-m-d H:m:s");
    $datos = array(                                                                                                                                                           
        "estado"                             => '2',
        "observaciones_aprobacion_cliente"   => $forma_observaciones_aprobacion_cliente,
        "fecha_registro_aprobacion_clientes" => $forma_fecha_registro_aprobacion_clientes,
        "fecha_registro_aprobacion_sistema"  => $forma_fecha_registro_aprobacion_sistema,
