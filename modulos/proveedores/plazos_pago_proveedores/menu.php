...
$vistaMenu     = "menu_plazos_pago_provedores";
$vistaBuscador = "buscador_plazos_pago_proveedores";
$alineacion    = array("I","C","C","C");
...
$botones  = HTML::boton("ADICPPPR",$textos["ADICIONAR"],"ejecutarComando(this, 550, 330);","adicionar");
$botones .= HTML::boton("CONSPPPR",$textos["CONSULTAR"],"ejecutarComando(this, 550, 330);","consultar");
$botones .= HTML::boton("MODIPPPR",$textos["MODIFICAR"],"ejecutarComando(this, 550, 330);","modificar");
$botones .= HTML::boton("ELIMPPPR",$textos["ELIMINAR"],"ejecutarComando(this, 550, 330);","eliminar");
