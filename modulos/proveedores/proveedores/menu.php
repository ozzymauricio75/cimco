...
$vistaMenu     = "menu_proveedores";
$vistaBuscador = "buscador_proveedores";
...
$botones  = HTML::boton("ADICPROV",$textos["ADICIONAR"],"ejecutarComando(this, 700, 430);","adicionar");
$botones .= HTML::boton("CONSPROV",$textos["CONSULTAR"],"ejecutarComando(this, 700, 430);","consultar");
$botones .= HTML::boton("MODIPROV",$textos["MODIFICAR"],"ejecutarComando(this, 700, 560);","modificar");
$botones .= HTML::boton("ELIMPROV",$textos["ELIMINAR"],"ejecutarComando(this, 700, 430);","eliminar");

/*** Obtener el nï¿½mero de la página actual ***/
if (empty($url_pagina)) {
    $paginaActual = 1;
} else {
