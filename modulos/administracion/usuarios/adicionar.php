...
if (!empty($url_generar)) {
    ...
    $formularios["PESTANA_GENERAL"] = array(
        ...
        array(
            HTML::campoTextoCorto("*correo", $textos["CORREO"], 30, 255, "", array("title" => $textos["AYUDA_CORREO"], "onBlur" => "validarItem(this);"))
        ),
        array(
    ...
    $formularios["PESTANA_ACCESO"] = array(
        ...
        array(
            HTML::campoTextoCorto("cambio_contrasena_minimo", $textos["CAMBIO_CONTRASENA_MINIMO"], 3, 3, "0", array("title" => $textos["AYUDA_CAMBIO_CONTRASENA_MINIMO"]))
        ),
        array(
            HTML::campoTextoCorto("cambio_contrasena_maximo", $textos["CAMBIO_CONTRASENA_MAXIMO"], 3, 3, "0", array("title" => $textos["AYUDA_CAMBIO_CONTRASENA_MAXIMO"]))
        ),
        array(
...
/*** Validar los datos provenientes del formulario ***/
    ...
    if ($url_item == "correo") {
        $existe = SQL::existeItem("usuarios", "correo", $url_correo);
...
/*** Adicionar los datos provenientes del formulario ***/
    ...
    } elseif (SQL::existeItem("usuarios", "usuario", $forma_usuario)) {
        $error   = true;
