...
$vistaMenu     = "menu_usuarios";
$vistaBuscador = "buscador_usuarios";
...
$botones  = HTML::boton("ADICUSUA",$textos["ADICIONAR"],"ejecutarComando(this, 400, 450);","adicionar");
$botones .= HTML::boton("CONSUSUA",$textos["CONSULTAR"],"ejecutarComando(this, 400, 450);","consultar");
$botones .= HTML::boton("MODIUSUA",$textos["MODIFICAR"],"ejecutarComando(this, 400, 450);","modificar");
$botones .= HTML::boton("ELIMUSUA",$textos["ELIMINAR"],"ejecutarComando(this, 400, 450);","eliminar");
