...
$vistaMenu     = "menu_secciones";
$vistaBuscador = "buscador_secciones";
...
$botones  = HTML::boton("ADICSECC",$textos["ADICIONAR"],"ejecutarComando(this, 480, 340);","adicionar");
$botones .= HTML::boton("CONSSECC",$textos["CONSULTAR"],"ejecutarComando(this, 350, 330);","consultar");
$botones .= HTML::boton("MODISECC",$textos["MODIFICAR"],"ejecutarComando(this, 480, 320);","modificar");
$botones .= HTML::boton("ELIMSECC",$textos["ELIMINAR"],"ejecutarComando(this, 350, 230);","eliminar");
