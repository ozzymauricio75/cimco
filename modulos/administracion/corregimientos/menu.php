...
$vistaMenu     = "menu_corregimientos";
$vistaBuscador = "buscador_corregimientos";
...
$botones  = HTML::boton("ADICCORR",$textos["ADICIONAR"],"ejecutarComando(this, 350, 380);","adicionar");
$botones .= HTML::boton("CONSCORR",$textos["CONSULTAR"],"ejecutarComando(this, 350, 310);","consultar");
$botones .= HTML::boton("MODICORR",$textos["MODIFICAR"],"ejecutarComando(this, 350, 430);","modificar");
$botones .= HTML::boton("ELIMCORR",$textos["ELIMINAR"],"ejecutarComando(this, 350, 330);","eliminar");
