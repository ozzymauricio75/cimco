...
$textos = array(
    "PREFUSUA"            => "Usuario",
    "ADICPREF"            => "Adicionar Preferencias",
    "CONSPREF"            => "Consultar Preferencias",
    "MODIPREF"            => "Modificar Preferencias",
    "ELIMPREF"            => "Eliminar Preferencias",
    "TIPO"		  => "Tipo",
    "VARIABLE"		  => "Variable",
    "VALOR"		  => "Valor",   
    "PREFERENCIA_USUARIO" => "Preferencias de Usuario",
    "USUARIO"             => "Usuario",
    "SUCURSAL"            => "Almacén",
    "PERFIL"              => "Perfil",
