...
$vistaMenu     = "menu_cargos";
$vistaBuscador = "buscador_cargos";
$alineacion    = array("C","I","C");
...
$botones  = HTML::boton("ADICCARG",$textos["ADICIONAR"],"ejecutarComando(this,450,280);","adicionar");
$botones .= HTML::boton("CONSCARG",$textos["CONSULTAR"],"ejecutarComando(this,400,280);","consultar");
$botones .= HTML::boton("MODICARG",$textos["MODIFICAR"],"ejecutarComando(this,450,280);","modificar");
$botones .= HTML::boton("ELIMCARG",$textos["ELIMINAR"],"ejecutarComando(this,400,280);","eliminar");
