...
$vistaMenu     = "menu_perfiles";
$vistaBuscador = "buscador_perfiles";
...
$botones  = HTML::boton("ADICPERF",$textos["ADICIONAR"],"ejecutarComando(this, 450, 400);","adicionar");
$botones .= HTML::boton("CONSPERF",$textos["CONSULTAR"],"ejecutarComando(this, 450, 400);","consultar");
$botones .= HTML::boton("MODIPERF",$textos["MODIFICAR"],"ejecutarComando(this, 450, 400);","modificar");
$botones .= HTML::boton("ELIMPERF",$textos["ELIMINAR"],"ejecutarComando(this, 450, 400);","eliminar");
