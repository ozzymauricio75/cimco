...
$vistaMenu     = "menu_paises";
$vistaBuscador = "buscador_paises";
...
$botones  = HTML::boton("ADICPAIS",$textos["ADICIONAR"],"ejecutarComando(this, 350, 240);","adicionar");
$botones .= HTML::boton("CONSPAIS",$textos["CONSULTAR"],"ejecutarComando(this, 350, 180);","consultar");
$botones .= HTML::boton("MODIPAIS",$textos["MODIFICAR"],"ejecutarComando(this, 350, 235);","modificar");
$botones .= HTML::boton("ELIMPAIS",$textos["ELIMINAR"],"ejecutarComando(this, 350, 250);","eliminar");
