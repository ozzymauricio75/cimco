...
$vistaMenu     = "menu_municipios";
$vistaBuscador = "buscador_municipios";
...
$botones  = HTML::boton("ADICMUNI",$textos["ADICIONAR"],"ejecutarComando(this, 350, 400);","adicionar");
$botones .= HTML::boton("CONSMUNI",$textos["CONSULTAR"],"ejecutarComando(this, 350, 345);","consultar");
$botones .= HTML::boton("MODIMUNI",$textos["MODIFICAR"],"ejecutarComando(this, 350, 400);","modificar");
$botones .= HTML::boton("ELIMMUNI",$textos["ELIMINAR"],"ejecutarComando(this, 350, 365);","eliminar");
