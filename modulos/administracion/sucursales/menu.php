...
$botones  = HTML::boton("ADICSUCU",$textos["ADICIONAR"],"ejecutarComando(this, 530, 570);","adicionar");
$botones .= HTML::boton("CONSSUCU",$textos["CONSULTAR"],"ejecutarComando(this, 480, 550);","consultar");
$botones .= HTML::boton("MODISUCU",$textos["MODIFICAR"],"ejecutarComando(this, 530, 570);","modificar");
$botones .= HTML::boton("ELIMSUCU",$textos["ELIMINAR"],"ejecutarComando(this, 480, 550);","eliminar");
