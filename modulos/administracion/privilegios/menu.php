...
$vistaMenu     = "menu_privilegios";
$vistaBuscador = "buscador_privilegios";
...
$botones  = HTML::boton("ADICPRIV",$textos["ADICIONAR"],"ejecutarComando(this, 350, 300);","adicionar");
$botones .= HTML::boton("CONSPRIV",$textos["CONSULTAR"],"ejecutarComando(this, 450, 400);","consultar");
$botones .= HTML::boton("MODIPRIV",$textos["MODIFICAR"],"ejecutarComando(this, 450, 400);","modificar");
$botones .= HTML::boton("ELIMPRIV",$textos["ELIMINAR"],"ejecutarComando(this, 450, 400);","eliminar");
...
$agrupamiento   = "";
$ordenamiento   = SQL::ordenColumnas("USUARIO ASC");
