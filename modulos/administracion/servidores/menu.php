...
$vistaMenu     = "menu_servidores";
$vistaBuscador = "buscador_servidores";
...
$botones  = HTML::boton("ADICSRVD",$textos["ADICIONAR"],"ejecutarComando(this,450,350);","adicionar");
$botones .= HTML::boton("CONSSRVD",$textos["CONSULTAR"],"ejecutarComando(this,400,350);","consultar");
$botones .= HTML::boton("MODISRVD",$textos["MODIFICAR"],"ejecutarComando(this,450,350);","modificar");
$botones .= HTML::boton("ELIMSRVD",$textos["ELIMINAR"],"ejecutarComando(this,400,350);","eliminar");
