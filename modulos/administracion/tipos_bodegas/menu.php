...
$vistaMenu     = "menu_tipos_bodegas";
$vistaBuscador = "buscador_tipos_bodegas";
...
$botones  = HTML::boton("ADICTIBO",$textos["ADICIONAR"],"ejecutarComando(this, 470, 300);","adicionar");
$botones .= HTML::boton("CONSTIBO",$textos["CONSULTAR"],"ejecutarComando(this, 350, 280);","consultar");
$botones .= HTML::boton("MODITIBO",$textos["MODIFICAR"],"ejecutarComando(this, 470, 300);","modificar");
$botones .= HTML::boton("ELIMTIBO",$textos["ELIMINAR"],"ejecutarComando(this, 350, 300);","eliminar");
