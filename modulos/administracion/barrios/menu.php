...
$botones  = HTML::boton("ADICBARR",$textos["ADICIONAR"],"ejecutarComando(this, 350, 430);","adicionar");
$botones .= HTML::boton("CONSBARR",$textos["CONSULTAR"],"ejecutarComando(this, 350, 345);","consultar");
$botones .= HTML::boton("MODIBARR",$textos["MODIFICAR"],"ejecutarComando(this, 350, 430);","modificar");
$botones .= HTML::boton("ELIMBARR",$textos["ELIMINAR"],"ejecutarComando(this, 350, 365);","eliminar");
