...
if (!empty($url_generar)) {
    ...
    if (empty($url_id)) {
        ...
        $formularios["PESTANA_GENERAL"] = array(
            ...
            array(
                HTML::campoTextoCorto("codigo_municipal", $textos["CODIGO_MUNICIPAL"], 3, 3, $datos->codigo_municipal, array("title" => $textos["AYUDA_CODIGO_MUNICIPAL"])),
            ...
            array(
                HTML::campoTextoCorto("estrato", $textos["ESTRATO"], 2, 2, $datos->estrato, array("title" => $textos["AYUDA_ESTRATO"])),
                HTML::campoTextoCorto("comuna", $textos["COMUNA"], 2, 2, $datos->comuna, array("title" => $textos["AYUDA_COMUNA"]))
            )
        );
...
/*** Modificar el elemento seleccionado ***/
    ...
    } elseif (!empty($forma_codigo_municipal) && SQL::existeItem("localidades", "codigo_municipal", $forma_codigo_municipal, "id != '$forma_id' AND id_municipio = '$forma_municipio'")) {
            $error   = true;
