...
$vistaMenu     = "menu_terminales";
$vistaBuscador = "buscador_terminales";
...
$botones  = HTML::boton("ADICTERM",$textos["ADICIONAR"],"ejecutarComando(this,450,390);","adicionar");
$botones .= HTML::boton("CONSTERM",$textos["CONSULTAR"],"ejecutarComando(this,400,390);","consultar");
$botones .= HTML::boton("MODITERM",$textos["MODIFICAR"],"ejecutarComando(this,450,390);","modificar");
$botones .= HTML::boton("ELIMTERM",$textos["ELIMINAR"],"ejecutarComando(this,400,390);","eliminar");
