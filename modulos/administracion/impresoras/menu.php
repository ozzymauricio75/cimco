...
$vistaMenu     = "menu_impresoras";
$vistaBuscador = "buscador_impresoras";
...
$botones  = HTML::boton("ADICIMPR",$textos["ADICIONAR"],"ejecutarComando(this,450,250);","adicionar");
$botones .= HTML::boton("CONSIMPR",$textos["CONSULTAR"],"ejecutarComando(this,400,250);","consultar");
$botones .= HTML::boton("MODIIMPR",$textos["MODIFICAR"],"ejecutarComando(this,450,250);","modificar");
$botones .= HTML::boton("ELIMIMPR",$textos["ELIMINAR"],"ejecutarComando(this,400,250);","eliminar");
