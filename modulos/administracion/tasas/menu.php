...
$vistaMenu     = "menu_tasas";
$vistaBuscador = "buscador_tasas";
...
$botones  = HTML::boton("ADICTASA",$textos["ADICIONAR"],"ejecutarComando(this,400,380);","adicionar");
$botones .= HTML::boton("CONSTASA",$textos["CONSULTAR"],"ejecutarComando(this,400,380);","consultar");
$botones .= HTML::boton("MODITASA",$textos["MODIFICAR"],"ejecutarComando(this,400,380);","modificar");
$botones .= HTML::boton("ELIMTASA",$textos["ELIMINAR"],"ejecutarComando(this,400,380);","eliminar");
$botones .= HTML::boton("EXPOTASA",$textos["EXPORTAR"],"ejecutarComando(this,400,380);","exportar");
