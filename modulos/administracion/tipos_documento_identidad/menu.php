...
$vistaMenu     = "menu_tipos_documento_identidad";
$vistaBuscador = "buscador_tipos_documento_identidad";
$alineacion    = array("C","C","I");
...
$botones  = HTML::boton("ADICTIDI",$textos["ADICIONAR"],"ejecutarComando(this,380,260);","adicionar");
$botones .= HTML::boton("CONSTIDI",$textos["CONSULTAR"],"ejecutarComando(this,380,250);","consultar");
$botones .= HTML::boton("MODITIDI",$textos["MODIFICAR"],"ejecutarComando(this,380,260);","modificar");
$botones .= HTML::boton("ELIMTIDI",$textos["ELIMINAR"],"ejecutarComando(this,380,260);","eliminar");
