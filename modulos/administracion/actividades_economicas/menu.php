...
$vistaMenu     = "menu_actividades_economicas";
$vistaBuscador = "buscador_actividades_economicas";
...
$botones  = HTML::boton("ADICAECO",$textos["ADICIONAR"],"ejecutarComando(this,350,250);","adicionar");
$botones .= HTML::boton("CONSAECO",$textos["CONSULTAR"],"ejecutarComando(this,350,240);","consultar");
$botones .= HTML::boton("MODIAECO",$textos["MODIFICAR"],"ejecutarComando(this,350,250);","modificar");
$botones .= HTML::boton("ELIMAECO",$textos["ELIMINAR"],"ejecutarComando(this,350,250);","eliminar");
