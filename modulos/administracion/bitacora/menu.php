...
$vistaMenu     = "menu_conexiones";
$vistaBuscador = "buscador_conexiones";
$alineacion    = array("C","C","I","C","C");
...
$botones = HTML::boton("CONSBITA",$textos["CONSULTAR"],"ejecutarComando(this, 750, 500);","consultar");
...
$agrupamiento   = "";
$ordenamiento   = SQL::ordenColumnas("id_fecha DESC");
