...
if (!empty($url_generar)) {
    ...
    $formularios["PESTANA_GENERAL"] = array(
        ...
        array(
            HTML::campoTextoCorto("codigo_dane", $textos["CODIGO_DANE"], 2, 2, "", array("title" => $textos["AYUDA_CODIGO_DANE"], "onBlur" => "validarItem(this);")),
...
/*** Validación en línea de los datos provenientes del formulario ***/
    ...
    if ($url_item == "nombre" && $url_valor) {
        $existe = SQL::existeItem("departamentos", "nombre", $url_valor);
    ...
    if ($url_item == "codigo_dane" && $url_valor) {
        $existe = SQL::existeItem("departamentos", "codigo_dane", $url_valor);
    ...
    if ($url_item == "codigo_interno" && $url_valor) {
        $existe = SQL::existeItem("departamentos", "codigo_interno", $url_valor);
...
/*** Adicionar los datos provenientes del formulario ***/
    ...
    } elseif (SQL::existeItem("departamentos", "nombre", $forma_nombre, "id_pais = '$forma_pais'")) {
        $error   = true;
        $mensaje =  $textos["ERROR_EXISTE_NOMBRE"];

    } elseif (SQL::existeItem("departamentos", "codigo_dane", $forma_codigo_dane, "id_pais = '$forma_pais'")) {
            $error   = true;
    ...
    } elseif (!empty($forma_codigo_interno) && SQL::existeItem("departamentos", "codigo_interno", $forma_codigo_interno, "id_pais = '$forma_pais'")) {
        $error   = true;
