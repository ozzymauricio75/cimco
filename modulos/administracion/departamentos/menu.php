...
$botones  = HTML::boton("ADICDEPA",$textos["ADICIONAR"],"ejecutarComando(this, 350, 290);","adicionar");
$botones .= HTML::boton("CONSDEPA",$textos["CONSULTAR"],"ejecutarComando(this, 350, 220);","consultar");
$botones .= HTML::boton("MODIDEPA",$textos["MODIFICAR"],"ejecutarComando(this, 350, 290);","modificar");
$botones .= HTML::boton("ELIMDEPA",$textos["ELIMINAR"],"ejecutarComando(this, 350, 250);","eliminar");
