...
$vistaMenu     = "menu_profesiones_oficios";
$vistaBuscador = "buscador_profesiones_oficios";
...
$botones  = HTML::boton("ADICPROF",$textos["ADICIONAR"],"ejecutarComando(this,450,280);","adicionar");
$botones .= HTML::boton("CONSPROF",$textos["CONSULTAR"],"ejecutarComando(this,400,280);","consultar");
$botones .= HTML::boton("MODIPROF",$textos["MODIFICAR"],"ejecutarComando(this,450,280);","modificar");
$botones .= HTML::boton("ELIMPROF",$textos["ELIMINAR"],"ejecutarComando(this,400,280);","eliminar");
