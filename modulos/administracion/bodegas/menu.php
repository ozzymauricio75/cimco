...
$vistaMenu     = "menu_bodegas";
$vistaBuscador = "buscador_bodegas";
$alineacion    = array("C","I","I","I","I");
...
$botones  = HTML::boton("ADICBODE",$textos["ADICIONAR"],"ejecutarComando(this, 480, 330);","adicionar");
$botones .= HTML::boton("CONSBODE",$textos["CONSULTAR"],"ejecutarComando(this, 350, 260);","consultar");
$botones .= HTML::boton("MODIBODE",$textos["MODIFICAR"],"ejecutarComando(this, 480, 390);","modificar");
$botones .= HTML::boton("ELIMBODE",$textos["ELIMINAR"],"ejecutarComando(this, 350, 330);","eliminar");
