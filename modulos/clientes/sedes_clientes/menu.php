...
$vistaMenu     = "menu_cotizaciones";
$vistaBuscador = "buscador_cotizaciones";
$alineacion    = array("C","I","I","I","I","I","D","I","I","I","I");
...
$botones  = HTML::boton("APROCOTI",$textos["APROBAR"],"ejecutarComando(this, 600,650);","aprobar");
$botones .= HTML::boton("RECOCOTI",$textos["RECOTIZAR"],"ejecutarComando(this, 600,700);","recotizar");
$botones .= HTML::boton("REPLCOTI",$textos["REEMPLAZAR"],"ejecutarComando(this, 900,700);","reemplazar");
$botones .= HTML::boton("EXPOCOTI",$textos["EXPORTAR"],"ejecutarComando(this,600,550);","exportar");
$botones .= HTML::boton("ANULCOTI",$textos["ANULAR"],"ejecutarComando(this, 600,550);","anular");
$botones .= HTML::boton("EJECCOTI",$textos["EJECUTAR"],"ejecutarComando(this, 600,550);","ejecutar");
...
/*** Nombre de la vista a partir de la cual se genera la tabla ***/
$vistaMenu     = "menu_sedes_clientes";
$vistaBuscador = "buscador_sedes_clientes";
...
/*** Generar botones de comandos ***/
$botones  = HTML::boton("ADICSEDE",$textos["ADICIONAR"],"ejecutarComando(this, 500, 580);","adicionar");
$botones .= HTML::boton("CONSSEDE",$textos["CONSULTAR"],"ejecutarComando(this, 500, 530);","consultar");
$botones .= HTML::boton("MODISEDE",$textos["MODIFICAR"],"ejecutarComando(this, 500, 580);","modificar");
$botones .= HTML::boton("ELIMSEDE",$textos["ELIMINAR"],"ejecutarComando(this, 500, 530);","eliminar");
