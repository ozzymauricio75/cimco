...
if (!empty($url_generar)) {
    ...
    if (SQL::filasDevueltas($consulta_privilegios)) {
        ...
        $error     = $textos["ERROR_SIN_PRIVILEGIO"];
        $titulo    = "";
        $contenido = "";
    }
...
/*** Validar los datos provenientes del formulario ***/
    ...
    if (empty($forma_fecha_desde) || empty($forma_fecha_hasta) || empty($forma_sucursales)){
        ...
        $forma_fecha_hasta .= " 23:59:59";
        //echo var_dump($forma_fecha_hasta);
        $registro_cotizaciones = SQL::seleccionar(array("cotizaciones"),array("*"),"$condicion_estado_cotizacion fecha_registro_cotizacion_consorciado BETWEEN '$forma_fecha_desde' AND '$forma_fecha_hasta'");
