...
$botones .= HTML::boton("EXPOCOTI",$textos["EXPORTAR"],"ejecutarComando(this,800,550);","exportar");
...
$botones .= HTML::boton("MODICOTI",$textos["MODIFICAR"],"ejecutarComando(this, 600,550);","modificar");
$botones .= HTML::boton("REPOCOTI",$textos["REPORTE"],"ejecutarComando(this, 600, 500);","reporte");
