...
$textos = array(
    ...
    "MUNICIPIO"                     => "Municipio",
    "PESTANA_UBICACION_CLIENTE"     => "Ubicación cliente",
    ...
    "AYUDA_DOCUMENTO_CLIENTE"       => "Documento de identidad",
    ...
    "AYUDA_MAX_CUOTAS_CONTADO"      => "Número máximo de cuotas dadas por el cliente para pago de contado",
    "AYUDA_TASA_PAGO_CONTADO"       => "Tasa de interés que cobra el cliente para pagos de contado",
    "AYUDA_MAX_CUOTAS_CREDITO"      => "Número máximo de cuotas dado por el cliente para pago a crédito",
