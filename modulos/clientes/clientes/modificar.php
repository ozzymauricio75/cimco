...
if (!empty($url_generar)) {
    ...
    if (empty($url_id)) {
        ...
        $formularios["PESTANA_CLIENTE"] = array(
            array(
                HTML::campoTextoCorto("*documento_identidad", $textos["DOCUMENTO_CLIENTE"], 15, 15, $datos->documento_identidad,array("title" => $textos["AYUDA_DOCUMENTO_CLIENTE"],"onblur" => "validarItem(this);"))
            ),
            array(                
            ...
            array(
                HTML::listaSeleccionSimple("*genero", $textos["GENERO"], $genero, SQL::obtenerValor("terceros", "genero", "id = $url_id"))
            ),
            array(
                HTML::campoTextoCorto("*razon_social", $textos["RAZON_SOCIAL"], 30, 100, $datos->razon_social, array("title" => $textos["AYUDA_RAZON_SOCIAL"], "onblur" => "validarItem(this)", "class" => "$valor_oculto_juridica")),
                HTML::campoTextoCorto("nombre_comercial", $textos["NOMBRE_COMERCIAL"], 30, 60, $datos->nombre_comercial, array("title" => $textos["AYUDA_NOMBRE_COMERCIAL"], "onblur" => "validarItem(this)"))
            ),
            array(
