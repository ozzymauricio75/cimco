...
$vistaMenu     = "menu_clientes";
$vistaBuscador = "buscador_clientes";
...
$botones  = HTML::boton("ADICCLIE",$textos["ADICIONAR"],"ejecutarComando(this, 700, 430);","adicionar");
$botones .= HTML::boton("CONSCLIE",$textos["CONSULTAR"],"ejecutarComando(this, 700, 430);","consultar");
$botones .= HTML::boton("MODICLIE",$textos["MODIFICAR"],"ejecutarComando(this, 700, 560);","modificar");
$botones .= HTML::boton("ELIMCLIE",$textos["ELIMINAR"],"ejecutarComando(this, 700, 430);","eliminar");
